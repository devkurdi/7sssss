...
const translations = {
  badini: {
    ...
    backToHome: 'فه گه ريان بو ده ستبيك',
    quizComplete: 'کویز درست بوو!',
    yourScore: 'خاڵێ تە',
    questions: 'پرسیار',
    ...
    timeRemaining: 'چرکە',
    category: 'جۆر',
    manageQuestions: 'بريفه برنا پرسیاران',
    manageCategories: 'بريفه برنا جۆران',
    logout: 'دەرچوو',
    ...
    confirmDelete: 'پشتراستي ژيبه يي',
  },
  sorani: {
    appName: '7S PSYAR KURD',
    welcome: 'بەخێربێیت',
